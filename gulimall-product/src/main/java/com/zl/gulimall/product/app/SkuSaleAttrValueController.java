...
public class SkuSaleAttrValueController {
    ...
    @RequestMapping("/skuIdInfo/{skuId}")
    //@RequiresPermissions("product:skusaleattrvalue:info")
    public R skuIdInfo(@PathVariable("skuId") Long skuId){
        List<SkuSaleAttrValueEntity> skuSaleAttrValue = skuSaleAttrValueService.skuIdInfo(skuId);
