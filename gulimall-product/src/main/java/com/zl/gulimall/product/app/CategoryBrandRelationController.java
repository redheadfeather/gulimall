...
import com.zl.gulimall.product.entity.CategoryBrandRelationEntity;
import com.zl.gulimall.product.service.CategoryBrandRelationService;
import com.zl.gulimall.product.vo.BrandVo;
...
//    }
    ...
    public R relationBrandsList(@RequestParam(value = "catId",required = true) Long catId){
        ...
        List<BrandVo> collect = brandsByCatId.stream().map(item -> {
            BrandVo brandVo = new BrandVo();
            brandVo.setBrandId(item.getBrandId());
            brandVo.setBrandName(item.getName());
            return brandVo;
