...
public class AttrGroupController {
   ...
   // @RequiresPermissions("product:attrgroup:delete")
    ...
    public R relationDelete(@RequestBody AttrGroupRelationVo[] attrGroupRelationVo){
    ...
    public R getAttrGroupWithAttrs(@PathVariable("catelogId")Long catelogId){
        List<AttrGroupWithAttrVo> attrGroupWithAttrVo = attrGroupService.getAttrGroupWithAttrs(catelogId);
